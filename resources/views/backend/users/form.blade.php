        ...
        <div class="box-body ">
            ...
            @if(!isset($hideOtherFields))
                ...
                <div class="form-group {{$errors->has('slug') ? ' has-error' : ''}} has-feedback">
                    {!! Form::label('slug') !!}<font color="red">*</font>
                ...
                <div class="form-group {{$errors->has('role') ? ' has-error' : ''}} has-feedback">
                    ...
                    @else
                        {!! Form::select('role',App\Role::pluck('display_name','id'),$user->exists ? $user->roles->first()->id : null,['class'=>'form-control','placeholder' => 'Escolha um cargo']) !!}
                    @endif
